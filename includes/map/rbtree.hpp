...
namespace ft
{
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator&   rb_tree<T, Compare, Alloc>::iterator::operator=(const iterator &other)
    {
        if (this == &other)
            return (*this);
        i_node = other.i_node;
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator&   rb_tree<T, Compare, Alloc>::iterator::operator=(const const_iterator &other)
    {
        if (this == &other)
            return (*this);
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::node_type   *rb_tree<T, Compare, Alloc>::iterator::get_ptr() const
    {
        return (i_node);
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator&   rb_tree<T, Compare, Alloc>::iterator::operator++()
    {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator   rb_tree<T, Compare, Alloc>::iterator::operator++(int)
    {
        iterator    temp = *this;
    ...
    template <class T, class Compare, class Alloc>
    bool        rb_tree<T, Compare, Alloc>::iterator::operator==(const iterator& other) const
    {
    ...
    template <class T, class Compare, class Alloc>
    bool        rb_tree<T, Compare, Alloc>::iterator::operator==(const const_iterator& other) const
    {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::reference   rb_tree<T, Compare, Alloc>::iterator::operator*() const
    {
        return (i_node->value);
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::pointer   rb_tree<T, Compare, Alloc>::iterator::operator->() const
    {
        return (&(i_node->value));
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator&   rb_tree<T, Compare, Alloc>::const_iterator::operator=(const const_iterator &other)
    {
        if (this == &other)
            return (*this);
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator&   rb_tree<T, Compare, Alloc>::const_iterator::operator=(const iterator &other)
    {
        if (this == &other)
            return (*this);
    ...
    template <class T, class Compare, class Alloc>
    const typename rb_tree<T, Compare, Alloc>::node_type   *rb_tree<T, Compare, Alloc>::const_iterator::get_ptr() const
    {
        return (ci_node);
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator&   rb_tree<T, Compare, Alloc>::const_iterator::operator++()
    {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator   rb_tree<T, Compare, Alloc>::const_iterator::operator++(int)
    {
    ...
    template <class T, class Compare, class Alloc>
    bool        rb_tree<T, Compare, Alloc>::const_iterator::operator==(const const_iterator& other) const
    {
    ...
    template <class T, class Compare, class Alloc>
    bool        rb_tree<T, Compare, Alloc>::const_iterator::operator==(const iterator& other) const
    {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator::reference   rb_tree<T, Compare, Alloc>::const_iterator::operator*() const
    {
        return (ci_node->value);
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator::pointer   rb_tree<T, Compare, Alloc>::const_iterator::operator->() const
    {
        return (&(ci_node->value));
    }

    template <class T, class Compare, class Alloc>
    rb_tree<T, Compare, Alloc>::node_type::node_type() : value(value_type())
    {
        parent = NULL;
        child[LEFT] = NULL;
        child[RIGHT] = NULL;
    ...
    template <class T, class Compare, class Alloc>
    rb_tree<T, Compare, Alloc>::node_type::node_type(const T &val) : value(val)
    ...
    template <class T, class Compare, class Alloc>
    rb_tree<T, Compare, Alloc>::node_type::node_type(const node_type& other) : value(other.value)
    {
        parent = NULL;
        child[LEFT] = NULL;
        child[RIGHT] = NULL;
    ...
    template <class T, class Compare, class Alloc>
    rb_tree<T, Compare, Alloc>::rb_tree(const key_compare& comp, const allocator_type& alloc) : t_comp(comp)
    {
        t_alloc_pair = alloc;
    ...
    template <class T, class Compare, class Alloc>
    rb_tree<T, Compare, Alloc>::rb_tree(const rb_tree& other) : t_comp(other.t_comp)
    {
    ...
    template <class T, class Compare, class Alloc>
    rb_tree<T, Compare, Alloc>& rb_tree<T, Compare, Alloc>::operator=(const rb_tree& other)
    {
        if (this == &other)
            return (*this);
        clear();
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator   rb_tree<T, Compare, Alloc>::begin()
    {
        if (root)
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator  rb_tree<T, Compare, Alloc>::begin() const
    {
        if (root)
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator   rb_tree<T, Compare, Alloc>::end()
    {
        return (iterator(loop_root));
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator  rb_tree<T, Compare, Alloc>::end() const
    {
        return (const_iterator(loop_root));
    }
    ...
    template <class T, class Compare, class Alloc>
    void rb_tree<T, Compare, Alloc>::clear_tree(node_type *node)
    {
        if (node->child[LEFT])
    ...
    template <class T, class Compare, class Alloc>
    void rb_tree<T, Compare, Alloc>::dealloc_node(node_type *node)
    {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::key_compare      rb_tree<T, Compare, Alloc>::key_comp() const
    {
        return (t_comp);
    }

    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::swap(rb_tree& x)
    {
    ...
    template <class T, class Compare, class Alloc>
    void rb_tree<T, Compare, Alloc>::set_loop_children(node_type* node)
    {
    ...
    template <class T, class Compare, class Alloc>
    void rb_tree<T, Compare, Alloc>::set_loop_children()
    {
        if (!root)
        {
    ...
    template <class T, class Compare, class Alloc>
    void rb_tree<T, Compare, Alloc>::copy_tree(node_type*& current, node_type* curr_parent, node_type* curr_copy)
    {
        if (!curr_copy)
            current = NULL;
        else
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::node_type*   rb_tree<T, Compare, Alloc>::get_grandparent(node_type *node)
    {
        if (node && node->parent)
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::node_type*   rb_tree<T, Compare, Alloc>::get_uncle(node_type *node)
    {
    ...
    template <class T, class Compare, class Alloc>
    pair<typename rb_tree<T, Compare, Alloc>::iterator, bool>    rb_tree<T, Compare, Alloc>::insert_node(node_type *node)
    {
    ...
    template <class T, class Compare, class Alloc>
    pair<typename rb_tree<T, Compare, Alloc>::iterator, bool>    rb_tree<T, Compare, Alloc>::insert_node(iterator pos, node_type *node)
    {
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::erase(iterator erase_it)
    {
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::setup_for_case(node_type *erase_node, pair<node_type*, node_type*> &replace_parent)
    {
        node_type *x = NULL;
    ...
    template <class T, class Compare, class Alloc>
    pair<typename rb_tree<T, Compare, Alloc>::node_type*, typename rb_tree<T, Compare, Alloc>::node_type*>
        rb_tree<T, Compare, Alloc>::bst_delete_node(node_type *node)
    {
    ...
    template <class T, class Compare, class Alloc>
    pair<typename rb_tree<T, Compare, Alloc>::node_type*, typename rb_tree<T, Compare, Alloc>::node_type*>
        rb_tree<T, Compare, Alloc>::bst_delete_w_children(node_type *node, size_type parent_dir)
    {
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::choose_erase_case(node_type *x, node_type *x_sibling)
    {
        if (x && x->is_red)
            x->is_red = false;
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::erase_case_1(node_type *x, node_type* w)
    {
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::erase_case_2(node_type *x, node_type* w)
    {
        node_type *parent = w->parent;
        w->is_red = true;
        x = parent;
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::erase_case_3(node_type *x, node_type* w)
    {
        node_type *parent = w->parent;
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::erase_case_4(node_type *x, node_type* w)
    {
        node_type *parent = w->parent;
        w->is_red = true;
        if (parent->child[LEFT] == x)
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::rotate(node_type *node, direction dir)
    {
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::rotate_tree(node_type *node)
    {
    ...
    template <class T, class Compare, class Alloc>
    void    rb_tree<T, Compare, Alloc>::balance_tree(node_type *node)
    {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator  rb_tree<T, Compare, Alloc>::find_node(const value_type &k)
    {
        node_type   *temp = root;
        while (temp)
        {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator    rb_tree<T, Compare, Alloc>::find_node(const value_type &k) const
    {
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator  rb_tree<T, Compare, Alloc>::lower_bound(const value_type& k)
    {
        node_type   *temp = root;
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator    rb_tree<T, Compare, Alloc>::lower_bound(const value_type& k) const
    {
        const node_type   *temp = root;
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::iterator  rb_tree<T, Compare, Alloc>::upper_bound(const value_type& k)
    {
        node_type   *temp = root;
        node_type   *before_temp = NULL;
        while (temp)
    ...
    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::const_iterator    rb_tree<T, Compare, Alloc>::upper_bound(const value_type& k) const
    {
        const node_type   *temp = root;
        const node_type   *before_temp = NULL;
        while (temp)
    ...
    template <class T, class Compare, class Alloc>
    pair<typename rb_tree<T, Compare, Alloc>::iterator,
    typename rb_tree<T, Compare, Alloc>::iterator>         rb_tree<T, Compare, Alloc>::equal_range(const value_type &k)
    {
        return (ft::make_pair(lower_bound(k), upper_bound(k)));
    }
        
    template <class T, class Compare, class Alloc>
    pair<typename rb_tree<T, Compare, Alloc>::const_iterator,
    typename rb_tree<T, Compare, Alloc>::const_iterator>    rb_tree<T, Compare, Alloc>::equal_range(const value_type &k) const
    {
        return (ft::make_pair(lower_bound(k), upper_bound(k)));
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::size_type     rb_tree<T, Compare, Alloc>::size() const
    {
        return (t_size);
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::allocator_type    rb_tree<T, Compare, Alloc>::get_allocator() const
    {
        return (t_alloc_pair);
    }

    template <class T, class Compare, class Alloc>
    typename rb_tree<T, Compare, Alloc>::allocator_node_type     rb_tree<T, Compare, Alloc>::get_alloc_node() const
    {
        return (t_alloc_node);
    }
}
